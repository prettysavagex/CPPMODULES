...
ClapTrap::ClapTrap()
{
	std::cout << "#THE CLAPTRAP DEFAULT CONSTRUCTOR HAS BEEN EXECUTED#" << std::endl;
}

ClapTrap::ClapTrap(std::string name) : name(name), hitPoint(10), energyPoint(10), attackDamage(0)
{
	std::cout << "#THE CLAPTRAP CONSTRUCTOR HAS BEEN EXECUTED#" << std::endl;
}

ClapTrap::ClapTrap(const ClapTrap& copy)
{
	std::cout << "#THE CLAPTRAP COPY CONSTRUCTER HAS BEEN EXECUTED#" << std::endl;
	*this = copy;
}

ClapTrap& ClapTrap::operator=(const ClapTrap& copy)
{
	std::cout << "#THE CLAPTRAP COPY ASSIGNMENT OPERATOR HAS BEEN EXECUTED#" << std::endl;
...
ClapTrap::~ClapTrap()
{
	std::cout << "#THE CLAPTRAP DESTRUCTOR HAS BEEN EXECUTED#" << std::endl;
}
